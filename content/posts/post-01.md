...
- 내부에서 사용하는 S3의 Sample 폴더를 동기화합니다. 
- 자료조사를 통해 관리되는 엑셀
- 해당 폴더를 읽어드려 노출되는 기본적인 데이터를 지정합니다. (제목, 파일, 경로)
...
태그(tags) : 디지털아카이브에서 임의적으로 구성한 컬렉션을 구성할 때 사용합니다. 예) 오프닝기념 컬렉션, 210327심포지움
...
### 디자인 페이지 | static pages

- 내부에서 사용하는 NAS의 Sample 폴더를 동기화합니다. 
- 해당 폴더를 읽어드려 노출되는 기본적인 데이터를 지정합니다. (제목, 파일, 경로)

## hugo-site building

- 해당 목록화면에 대해서 디자인 확인 이후
- tailwind-aa-theme 기본 형태로 진행
